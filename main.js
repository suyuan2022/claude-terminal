...
var require_addon_search = __commonJS({
  "node_modules/@xterm/addon-search/lib/addon-search.js"(exports, module2) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module2 ? module2.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.SearchAddon = t() : e.SearchAddon = t();
    }(self, () => (() => {
      "use strict";
      var e = { 345: (e2, t2) => {
        Object.defineProperty(t2, "__esModule", { value: true }), t2.runAndSubscribe = t2.forwardEvent = t2.EventEmitter = void 0, t2.EventEmitter = class {
      ...
      return (() => {
        ...
        class n extends r.Disposable {
          constructor(e3) {
            var _a;
            super(), this._highlightedLines = /* @__PURE__ */ new Set(), this._highlightDecorations = [], this._selectedDecoration = this.register(new r.MutableDisposable()), this._linesCacheTimeoutId = 0, this._linesCacheDisposables = new r.MutableDisposable(), this._onDidChangeResults = this.register(new t2.EventEmitter()), this.onDidChangeResults = this._onDidChangeResults.event, this._highlightLimit = (_a = e3 == null ? void 0 : e3.highlightLimit) != null ? _a : 1e3;
          }
          activate(e3) {
          ...
          _highlightAllMatches(e3, t3) {
            ...
            for (; r2 && ((s2 == null ? void 0 : s2.row) !== r2.row || (s2 == null ? void 0 : s2.col) !== r2.col) && !(i2.length >= this._highlightLimit); )
          ...
          _find(e3, t3, i2, s2) {
            ...
            if (!this._terminal || !e3 || 0 === e3.length)
              return (_a = this._terminal) == null ? void 0 : _a.clearSelection(), void this.clearDecorations();
            ...
            if (r2 = this._findInLine(e3, o2, s2), !r2)
              for (let i3 = t3 + 1; i3 < this._terminal.buffer.active.baseY + this._terminal.rows && (o2.startRow = i3, o2.startCol = 0, r2 = this._findInLine(e3, o2, s2), !r2); i3++)
                ;
            return r2;
          }
          _findNextAndSelect(e3, t3) {
            var _a;
            if (!this._terminal || !e3 || 0 === e3.length)
              return (_a = this._terminal) == null ? void 0 : _a.clearSelection(), this.clearDecorations(), false;
            ...
            if (!n2)
              for (let i3 = r2 + 1; i3 < this._terminal.buffer.active.baseY + this._terminal.rows && (o2.startRow = i3, o2.startCol = 0, n2 = this._findInLine(e3, o2, t3), !n2); i3++)
                ;
            if (!n2 && 0 !== r2)
              for (let i3 = 0; i3 < r2 && (o2.startRow = i3, o2.startCol = 0, n2 = this._findInLine(e3, o2, t3), !n2); i3++)
                ;
          ...
          _findPreviousAndSelect(e3, t3) {
            ...
            if (!h && s2 !== this._terminal.buffer.active.baseY + this._terminal.rows - 1)
              for (let i3 = this._terminal.buffer.active.baseY + this._terminal.rows - 1; i3 >= s2 && (n2.startRow = i3, h = this._findInLine(e3, n2, t3, o2), !h); i3--)
                ;
          ...
          _findInLine(e3, t3, i2 = {}, s2 = false) {
            ...
            if (h == null ? void 0 : h.isWrapped)
              return s2 ? void (t3.startCol += r2.cols) : (t3.startRow--, t3.startCol += r2.cols, this._findInLine(e3, t3, i2));
            ...
            if (i2.regex) {
              ...
              let i3;
              if (s2)
                for (; i3 = t4.exec(u.slice(0, d)); )
                  f = t4.lastIndex - i3[0].length, e3 = i3[0], t4.lastIndex -= e3.length - 1;
              else
                i3 = t4.exec(u.slice(d)), i3 && i3[0].length > 0 && (f = d + (t4.lastIndex - i3[0].length), e3 = i3[0]);
            } else
              s2 ? d - _.length >= 0 && (f = u.lastIndexOf(_, d - _.length)) : f = u.indexOf(_, d);
            if (f >= 0) {
              if (i2.wholeWord && !this._isWholeWord(f, u, e3))
                return;
              let t4 = 0;
              for (; t4 < c.length - 1 && f >= c[t4 + 1]; )
                t4++;
              let s3 = t4;
              for (; s3 < c.length - 1 && f + e3.length >= c[s3 + 1]; )
                s3++;
          ...
          _selectResult(e3, t3, i2) {
            ...
            if (this._selectedDecoration.clear(), !e3)
...
var PtyManager = class {
  constructor(helperPath, options = {}) {
  ...
  start(onData, onExit) {
    ...
    this.resizeStream = this.process.stdio[3];
...
var TerminalView = class _TerminalView extends import_obsidian.ItemView {
  ...
  onOpen() {
    ...
    this.terminal.loadAddon(new import_addon_search.SearchAddon());
    ...
    this.terminal.attachCustomKeyEventHandler((event) => {
      ...
      if (event.type !== "keydown")
        return true;
      if (((_a = this.terminal) == null ? void 0 : _a.buffer.active.type) !== "normal")
        return true;
      if (event.metaKey && event.key === "ArrowDown") {
        event.preventDefault();
        event.stopPropagation();
        (_b = this.terminal) == null ? void 0 : _b.scrollToBottom();
        return false;
      }
      if (event.metaKey && event.key === "ArrowUp") {
        event.preventDefault();
        event.stopPropagation();
        (_c = this.terminal) == null ? void 0 : _c.scrollToTop();
        return false;
      }
      return true;
    });
...
\x1B[1;31mProcess exited with code ${code}\x1B[0m\r
`);
        }
      }
    );
  ...
  focusTerminal() {
    ...
    if ((_a = this.terminal) == null ? void 0 : _a.textarea) {
      requestAnimationFrame(() => {
        var _a2;
...
var ClaudeTerminalPlugin = class extends import_obsidian2.Plugin {
  constructor() {
    super(...arguments);
    this.helperPath = "";
    this.customCwd = null;
